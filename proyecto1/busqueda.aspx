    ...
    <div class="d-flex flex-wrap justify-content-center align-items-center mt-5">
        <% foreach(var articulo in articuloList) { %>                
            <div class="card m-3" style="width:18rem;">
                <img class="card-img-top" height="255px" src="<%: !(string.IsNullOrEmpty(articulo.imagenUrl)) ? articulo.imagenUrl : "https://plantillasdememes.com/img/plantillas/imagen-no-disponible01601774755.jpg" %>"/>
