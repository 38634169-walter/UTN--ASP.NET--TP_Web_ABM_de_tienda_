...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="bajoMenu pt-4 fondo4">
        ...
        <div class="bajoMenu d-flex justify-content-center align-items-center flex-column text-center titulo2 mt-3 fondo2 rounded-circle shadow py-3 mx-2">
            ...
            <% foreach(var articulo in articuloList) { %>                
                <div class="card m-3 shadow" style="width:18rem;">
                    ...
                    <div class="d-flex justify-content-center align-items-start my-2">
                        <a class="btn btn-warning fw-bold text-light px-5" href="verArticulo.aspx?id=<%: articulo.id %>" >Ver</a>
                    </div>
                </div>
            <% } %>
            <% if (!articuloList.Any()) { %>
